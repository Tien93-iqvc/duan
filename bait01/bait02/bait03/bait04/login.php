...
<div class="group-box">
	...
	<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST" name="frmLogin">
		...
		<tr> 
			...
			<td align="left"><input type="text" name="txtTenDangNhap" placeholder="Nhập tên đăng nhập"> </td>
		</tr>
		<tr>
			<td align="right"> <label for="txtMatKhau"> Mật khẩu: </label></td>
			 <td align="left"> <input type="password" name="txtMatKhau" placeholder="Nhập tên mật khẩu"> <br /> </td>
		</tr>		
		<tr>
			<td>  &nbsp; </td>				
			<td> <input type="radio" name="rdodn" value="sv" checked>Sinh Viên 
				 <input type="radio" name="rdodn" value="gv" >Admin 
			  </td>
		</tr>
		<tr>
			<td> &nbsp; </td> 
